...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '新竹市國文科數位輔導團', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '新竹市竹光國中', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://notion-next-gamma-blush.vercel.app/', // 网站地址
